...
import com.demo.demo.repository.ShipmentRepository;
...
public class ShipmentService {
    ...
    public Shipment getShipmentWithDeliveries(Long shipmentId) {
        return repo.findShipmentWithDeliveries(shipmentId);
    }
}
